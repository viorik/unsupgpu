local UnsupgpuTrainer = torch.class('unsupgpu.UnsupTrainer')

function UnsupgpuTrainer:__init(module,data)
...
function UnsupgpuTrainer:train(params)
   -- essential stuff
...
function UnsupgpuTrainer:computeDiagHessian(params)
...
function UnsupgpuTrainer:trainSample(ex, eta)
   local module = self.module
   local parameters = self.parameters
